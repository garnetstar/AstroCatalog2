...
import cz.uhk.machacek.UI.CompasView;
import cz.uhk.machacek.UI.HorizontView;
import cz.uhk.machacek.Model.AstroObject;
...
/**
 * Activita pro zobrazení prvků pro navigaci na objekt
 * 
 * @author Jan Macháček
 *
 */
public class PointerActivity extends Activity implements 
	...
	private void checkMagneticFieldSupported(Context context) {
		...
		if (sensors.size() < 1) {
			Toast.makeText(
					getBaseContext(),
					"V� p��stroj nepobsahuje senzor Magnetic Field, funkce k ur�en� orientace nebudou fungovat spr�vn�.",
