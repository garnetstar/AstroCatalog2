...
import cz.uhk.machacekgoogle.library.MovingAverage;
...
/**
 * Vlastní View pro určení výšky nad obzorem
 * 
 * @author Jan Macháček
 *
 */
public class HorizontView extends View {
	...
	protected void onDraw(Canvas canvas) {
		...
		// pohybliv� ukazatel v��ky nad obzorem
