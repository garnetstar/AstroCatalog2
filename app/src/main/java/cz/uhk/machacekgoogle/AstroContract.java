...
public class AstroContract {
    ...
    public static final String CATALOG_AUTHORITY = "cz.uhk.machacekgoogle.astro.provider";
    public static final String DIARY_AUTHORITY = "cz.uhk.machacekgoogle.astro.diaryProvider";
